...
//   const {data: productsData, isLoading} = useFetchAllProductsQuery(undefined);

//   if(isLoading) return <Skeleton />
  

  
//   const products = productsData?.data?.result as TProduct[];
...
//               className='p-2  hover:border-lime-600 hover:bg-primary hover:text-white hover:rounded-full transition-colors'
...
//               className='p-2 border-gray-200 hover:bg-primary hover:text-white hover:rounded-full hover:border-lime-600 transition-colors'
