...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-[56px] items-center justify-center p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
